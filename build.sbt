...
scalacOptions ++= Seq(
  ...
  //  "-Xlint:nullary-override",           // Warn when non-nullary `def f()' overrides nullary `def f'. Removed in 2.13.3
  ...
  //  "-Wself-implicit",                   // Warn when an implicit resolves to an enclosing self-definition. Removed in 2.13.3
